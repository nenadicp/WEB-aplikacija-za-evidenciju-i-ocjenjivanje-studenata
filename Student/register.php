    ...
    if(isset($_POST['register_btn'])){
        ...
        if($password == $password2) {
            ...
            if(mysqli_num_rows($query) > 0){
                ...
                $sql = "INSERT INTO student (ime, prezime, username, password, email, godina) VALUES ('$ime', '$prezime', '$username', '$password', '$email', '$godina')";
                $query = mysqli_query($db, $sql);
...
<html>
<head>
    <title>Studenti - registracija</title>
...
<body>
    <div class="header">
        ...
        <h3>Registracija za stranicu Studenti</h3>
    </div>
    <br>
    <div>
    ...
    <form method="post" action="register.php">
        <table>
            ...
            <tr>
                <td>Godina:</td>
                <td><select name="godina" id="godina" class="select">
