...
<body>
    <div class="header">
        ...
        <h3>Stranica za prijavu - Student</h3>
    </div>
    <br>
    <div>
    ...
    <form method="post" action="login.php">
        <table align="center">
            ...
            <tr>
                ...
                <td><input class="unos" type="password" name="password" id="password" class="textInput">
                <input type="checkbox" onclick="myFunction()">Prikaži</td>
            </tr>
            <tr></tr>
            <tr></tr>
